...
O postman também é uma ferramenta de trabalho muito prática para o desenvolvimento e a collection e environment para atuação no serviço está disponível em https://github.com/thallis-andre/.github/tree/main/resources/postman
